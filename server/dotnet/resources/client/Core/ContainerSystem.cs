...
namespace NeptuneEvo.Core
{
    class ContainerSystem : Script
    {
        ...
        {
            if (!Group.CanUseCmd(player, "statebox")) return;
    ...
    public class Container
    {
        ...
        public void OpenDoor()
        {
            ...
            Timers.Start($"openDoorContainer{ID}", 1, () =>
            {
                ...
                NAPI.Task.Run(() => { Door_l.Rotation -= new Vector3(0, 0, 1); }); //Door_l.Rotation -= new Vector3(0, 0, 1);
                NAPI.Task.Run(() => { Door_R.Rotation -= new Vector3(0, 0, -1); }); //Door_R.Rotation -= new Vector3(0, 0, -1);
            });
        }
        #endregion
