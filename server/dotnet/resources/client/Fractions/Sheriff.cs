...
namespace NeptuneEvo.Fractions
{
    class Sheriff : Script
    {
        ...
        public static void clearWantedLvl1(Player sender, params object[] arguments)
        {
            ...
            } catch (Exception e) { Log.Write("ClearWantedLvl1: " + e.Message, nLog.Type.Error); }
        }
        ...
        public static void checkNumber1(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("checkNumber1: " + e.Message, nLog.Type.Error); }
        }
        ...
        public static void checkPerson1(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("checkPerson1: " + e.Message, nLog.Type.Error); }
        }
        ...
        public static void checkWantedList1(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("checkWantedList1: " + e.Message, nLog.Type.Error); }
        }
        ...
        public static void openCopcarmenu1(Player sender, params object[] arguments)
        {
            ...
            catch (Exception e) { Log.Write("openCopCarMenu1: " + e.Message, nLog.Type.Error); }
        }
        ...
        public static void interactPressed(Player player, int interact)
        {
            ...
            switch (interact)
            {
                case 100:
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы не сотрудник Sheriff", 3000);
                        return;
                    }
                ...
                case 110:
                    ...
                    else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы не сотрудник Sheriff", 3000);
                    return;
                case 120:
                    if (Main.Players[player].FractionID != 18)
                    {
