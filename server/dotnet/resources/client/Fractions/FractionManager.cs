...
namespace NeptuneEvo.Fractions
{
    ...
    class Stocks : Script
    {
        ...
        private static Dictionary<int, Vector3> stockCoords = new Dictionary<int, Vector3>()
        {
            ...
            { 3, new Vector3(486.7317, -1527.169, -33.2506)},
            { 4, new Vector3(1424.026, -1488.611, -104.3677)},
            { 5, new Vector3(901.4553, -2166.65, 0.92118)},
            { 6, new Vector3()},
            { 7, new Vector3()},
            { 8, new Vector3()},
            { 9, new Vector3()},
        ...
        private static Dictionary<int, Vector3> garageCoords = new Dictionary<int, Vector3>()
        {
            ...
            { 3, new Vector3(504.1188, -1496.41, 27.28829)},
            { 4, new Vector3(1401.759, -1514.474, 56.26676)},
            { 5, new Vector3(873.6498, -2197.615, 28.51937)},
